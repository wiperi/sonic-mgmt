...
# (Pdb) pp duthost.console_facts()
# {'_ansible_no_log': False,
#  'ansible_facts': {'console_facts': {'enabled': True,
#                                      'lines': {'1': {'baud_rate': 9600,
#                                                      'flow_control': False,
#                                                      'remote_device': 'Terminal1',
#                                                      'state': 'IDLE'},
#                                                '10': {'baud_rate': 9600,
#                                                       'flow_control': False,
#                                                       'remote_device': 'Terminal10',
#                                                       'state': 'IDLE'},
#                                                '11': {'baud_rate': 9600,
#                                                       'flow_control': False,
#                                                       'remote_device': 'Terminal11',
#                                                       'state': 'IDLE'},
